...
Func BossBattleVictor($sLogPath)
	...
	While 1
		...
		;EndIf
		$aPos = PixelSearch(933, 300, 933, 431, 0x7E4588)
		If Not @error Then
			AdlibUnRegister("Shoot")
			;	ConsoleWrite(' FlameNormal ')

			;leep(1000)
		EndIf
		$aPos = PixelSearch(857, 300, 857, 431, 0x7E4588)
		If Not @error Then
			AdlibUnRegister("Shoot")
				Local $vFound=	FindPixelUntilFound(933, 300, 933, 431, '0x7E4588', 100)
