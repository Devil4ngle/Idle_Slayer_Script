...
Func BossBattleVictor($sLogPath)
	...
	Local $iCheckSum
		_GDIPlus_Startup()
		Local $hBitmap = _ScreenCapture_Capture("",0,0,@DesktopWidth,@DesktopHeight,False)
	...
	While 1
		...
		getBitmapGetPixel($hImage,$POS[0],$POS[1]),1)
	Sleep(200)
	ControlSend("Idle Slayer", "", "", "{Up up}")
		Sleep(1000)
		$aPos=PixelSearch(856, 170, 856, 422, 0xCD963F)
		If Not @error Then
